"""RL configuration for Unitree Go1 direction task."""
...
def unitree_go1_direction_ppo_runner_cfg() -> RslRlOnPolicyRunnerCfg:
    """Create PPO runner configuration for Unitree Go1 direction task."""
...
def unitree_go1_direction_distillation_runner_cfg() -> RslRlDistillationRunnerCfg:
    """Create DAgger distillation runner configuration for Unitree Go1 direction task."""
